...
def main():
    igaku_file = "../../data/raw/qa/igaku/igaku_before.csv"  # 医学の事前アンケート
    riko_file = "../../data/raw/qa/riko/riko_before.csv"  # 理工の事前アンケート
    output_file = "../../data/raw/qa/riko/riko_before_clean.csv"

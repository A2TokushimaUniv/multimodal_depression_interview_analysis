...
def extract_vggish_feature(input_data_dir):
    ...
    for igaku_voice_file in igaku_voice_files:
        logger.info(f"Extracting VGGish feature from {igaku_voice_file}....")
        # VGGishの特徴量を取得
